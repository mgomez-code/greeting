...
//If someone clicks to consult answer oracle,  execute get_to_greet
//Si alguien hace clic para consultar respuesta oráculo, ejecute get_to_greet
$('#answerBtn').click(async function(){
	$("#loader").show();
	client = await Ae.Aepp();
	const consul = await callStatic('get_to_greet',[string]);
...
$('#oraculoBtn').click(async function(){
  $("#loader").show();
   client = await Ae.Aepp();
   const consul = await callStatic('get_oracle',[]);
   document.getElementById("textnotice").innerHTML = "Address oracle: </br>"+consul;
   div = document.getElementById('notice');
   div.style.display = '';
  $("#loader").hide();
});

//If someone clicks to consult balance oracle,  execute get_balance
//Si alguien hace clic para consultar balance oráculo, ejecute get_balance
$('#balanceBtn').click(async function(){
  $("#loader").show();
   client = await Ae.Aepp();
   const consul = await callStatic('get_balance',[]);
   document.getElementById("textnotice").innerHTML = "Balance: "+consul;
   div = document.getElementById('notice');
   div.style.display = '';
  $("#loader").hide();
});
